        ...
        <div className={`headerContainer ${props.headerBg ? 'changeBgColor' : 'changeBgColorTransparent'}`}>
            ...
            <Link className="logo" to="/">
                <div className="logo">
                    ...
                    <span className="logo">Web Learn</span>
                </div>
            </Link>
            ...
            <div className="navMenu">
                ...
                <div className={`${props.currentActive==='realworld' ? 'active' : ''} navItem`}>
                    <Link 
                        className="navLink" 
                ...
                <div className={`${props.currentActive==='roadmap' ? 'active' : ''} navItem`}>
                    <Link 
                        className="navLink" 
                ...
                <div className={`${props.currentActive==='usefulresources' ? 'active' : ''} navItem`}>
                    <Link 
                        className="navLink" 
