...
import UsefulResources from './screens/UsefulResources';
...
import RealWorld from './screens/RealWorld';
  ...
  return (
    <BrowserRouter>
      <div className="app">
        ...
        <main>
            <Route path="/realworld" render={(props) => 
              <RealWorld history={props.history} data={data} headerBg={headerBg} setHeaderBg={setHeaderBg} currentActive={currentActive} setCurrentActive={setCurrentActive}/>} 
            ></Route>
            ...
            <Route path="/roadmap" render={(props) => 
              <Roadmap history={props.history} data={data} headerBg={headerBg} setHeaderBg={setHeaderBg} currentActive={currentActive} setCurrentActive={setCurrentActive}/>} 
            ></Route>
            <Route path="/usefulresources" render={(props) => 
              <UsefulResources history={props.history} data={data} headerBg={headerBg} setHeaderBg={setHeaderBg} currentActive={currentActive} setCurrentActive={setCurrentActive} />}
            ></Route>
